...
int main()
{
   ...
   //      as if we are drawing using the painter's algorithm, i.e. newer pixels overwrite older pixels.
        window.draw(green,
            sf::StencilMode{ sf::StencilComparison::LessEqual, sf::StencilUpdateOperation::Replace, 1, ~0u, false });
   ...
   //          the last draw call in the frame.
           window.draw(blue,
               sf::StencilMode{ sf::StencilComparison::Greater, sf::StencilUpdateOperation::Replace, 1, ~0u, false });
